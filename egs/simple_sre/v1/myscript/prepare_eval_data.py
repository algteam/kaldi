...
for parent, dirnames, filenames in os.walk(eval_wav):
    for fn in filenames:
...
uttlist = open(eval_result + '/data/eval/utt.list', 'w')
utt2spk = open(eval_result + '/data/eval/utt2spk', 'w')
wavscp = open(eval_result + '/data/eval/wav.scp', 'w')
spk2utt = open(eval_result + '/data/eval/spk2utt', 'w')
